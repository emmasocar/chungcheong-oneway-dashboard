...
--   순 GP 개선: 4.79억 (건당 12,367원, 24h주차비+기회비용 차감 후)
--
-- 충청
...
--   순 GP 개선: 967만 (건당 6,633원, 24h주차비+기회비용 차감 후)
--
-- 건당 경제성 (수정, 2026-04-03)
--   AS-IS: 탁송비 16,087 + 핸들러주차 2,295 = 18,382원 (소속존 복귀 ~2시간)
--   TO-BE 비용: 24h주차 10,000 + 기회비용 8,052(22h×366) + 재배치 10,000 = 28,052원
--   TO-BE 수익: B고객 GP 12,275원
--   순 GP 개선: 15,849 + 2,295 + 12,275 - 10,000 - 8,052 = 12,367원/건
